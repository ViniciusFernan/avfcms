...
class InstallMenuTables
{
    ...
    {
        try {
            $insertMenus = "INSERT INTO menu_backend (idMenu, icon, nome, controller, private, ordem) 
                            VALUES ('1', 'fas fa-folder-open', 'Menu', 'menu', '1', '1'),
                                   ('2', 'la la-dashboard', 'Dashboard', 'dashboard', '0','2'),
                                   ('3', 'fas fa-user-friends', 'Usuario', 'usuario', '0','3');";
