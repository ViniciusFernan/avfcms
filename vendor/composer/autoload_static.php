...
class ComposerStaticInit801d6556a629b2521f6d0350a0ca4d12
{
    ...
    public static $classMap = array (
        'Application' => __DIR__ . '/../..' . '/core/Application.class.php',
        'AuthController' => __DIR__ . '/../..' . '/app/controllers/auth/AuthController.php',
        'AuthDAO' => __DIR__ . '/../..' . '/app/models/auth/dao/AuthDAO.php',
        'AuthModel' => __DIR__ . '/../..' . '/app/models/auth/model/AuthModel.php',
        'CadastroController' => __DIR__ . '/../..' . '/app/controllers/CadastroController.php',
        'ChecaCadastroUsuarioStrategy' => __DIR__ . '/../..' . '/app/models/usuario/strategy/ChecaCadastroUsuarioStrategy.php',
        'ChecaMenuCadastradoStrategy' => __DIR__ . '/../..' . '/app/models/menu/strategy/ChecaMenuCadastradoStrategy.php',
        'Composer\\InstalledVersions' => __DIR__ . '/..' . '/composer/InstalledVersions.php',
        'Conn' => __DIR__ . '/../..' . '/core/Conn/Conn.class.php',
        'Create' => __DIR__ . '/../..' . '/core/Conn/Create.class.php',
        'Curl' => __DIR__ . '/../..' . '/core/Helpers/Curl.class.php',
        'DashboardController' => __DIR__ . '/../..' . '/app/controllers/DashboardController.php',
        'DefaultModel' => __DIR__ . '/../..' . '/app/models/DefaultModel.php',
        'Delete' => __DIR__ . '/../..' . '/core/Conn/Delete.class.php',
        ...
        'InstallMenuTables' => __DIR__ . '/../..' . '/install/class/InstallMenuTables.php',
        'InstallUsuarioTables' => __DIR__ . '/../..' . '/install/class/InstallUsuarioTables.php',
        'Log' => __DIR__ . '/../..' . '/core/Helpers/Log.class.php',
        'LogarComoModel' => __DIR__ . '/../..' . '/app/models/auth/model/LogarComoModel.php',
        'Mailer' => __DIR__ . '/../..' . '/app/models/mailer/model/MailerModel.php',
        'MainController' => __DIR__ . '/../..' . '/core/MainController.class.php',
        'MenuController' => __DIR__ . '/../..' . '/app/controllers/MenuController.php',
        'MenuDAO' => __DIR__ . '/../..' . '/app/models/menu/dao/MenuDAO.php',
        'MenuFactory' => __DIR__ . '/../..' . '/app/models/menu/factory/MenuFactory.php',
        'MenuModel' => __DIR__ . '/../..' . '/app/models/menu/model/MenuModel.php',
        'NovoMenuStrategy' => __DIR__ . '/../..' . '/app/models/menu/strategy/NovoMenuStrategy.php',
        'NovoUsuarioStrategy' => __DIR__ . '/../..' . '/app/models/usuario/strategy/NovoUsuarioStrategy.php',
        'PDF' => __DIR__ . '/../..' . '/app/models/pdf/model/PDFModel.php',
        'Page404Controller' => __DIR__ . '/../..' . '/app/controllers/Page404Controller.php',
        'RecuperarSenhaController' => __DIR__ . '/../..' . '/app/controllers/RecuperarsenhaController.php',
        'RecuperarSenhaUsuarioStrategy' => __DIR__ . '/../..' . '/app/models/usuario/strategy/RecuperarSenhaUsuarioStrategy.php',
        'Select' => __DIR__ . '/../..' . '/core/Conn/Select.class.php',
        'Update' => __DIR__ . '/../..' . '/core/Conn/Update.class.php',
        'UsuarioController' => __DIR__ . '/../..' . '/app/controllers/UsuarioController.php',
        'UsuarioDAO' => __DIR__ . '/../..' . '/app/models/usuario/dao/UsuarioDAO.php',
        'UsuarioFactory' => __DIR__ . '/../..' . '/app/models/usuario/factory/UsuarioFactory.php',
        'UsuarioModel' => __DIR__ . '/../..' . '/app/models/usuario/model/UsuarioModel.php',
        'UsuarioSessaoFactory' => __DIR__ . '/../..' . '/app/models/usuario/factory/UsuarioSessaoFactory.php',
        'Util' => __DIR__ . '/../..' . '/core/Helpers/Util.class.php',
        'Verot\\Upload\\Upload' => __DIR__ . '/..' . '/verot/class.upload.php/src/class.upload.php',
        'View' => __DIR__ . '/../..' . '/core/View.class.php',
        'XLS' => __DIR__ . '/../..' . '/app/models/xls/model/XLSModel.php',
        'configClass' => __DIR__ . '/../..' . '/install/class/configClass.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit801d6556a629b2521f6d0350a0ca4d12::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit801d6556a629b2521f6d0350a0ca4d12::$prefixDirsPsr4;
